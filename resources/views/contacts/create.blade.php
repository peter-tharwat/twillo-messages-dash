...
<div class="col-12 py-0 px-3 row">
	 <div class="col-12  pt-4" style="background: #fff;min-height: 80vh">
	 	<div class="col-12 px-3">
	 		<h4>إضافة جهة إتصال</h4>
	 	</div>
	 	<div class="col-12 col-lg-9 px-3 py-5">
	 		<form class="col-12" method="POST" action="{{route('contacts.store')}}">
	 			@csrf 
	 		...
	 		<div class="col-12 col-md-6 px-0 d-flex mb-3">
	 			...
	 			<div class="col-9 px-2">
	 				<input type="" name="f_name" class="form-control" value="{{old('f_name')}}" required="" min="2" max="255">
	 			</div> 
	 		</div>
	 		<div class="col-12 col-md-6 px-0 d-flex mb-3">
	 			<div class="col-3 px-2 text-start pt-1">
	 			...
	 			<div class="col-9 px-2">
	 				<input type="" name="l_name" class="form-control" value="{{old('l_name')}}" required="" min="2" max="255">
	 			</div> 
	 		</div>
	 		<div class="col-12 col-md-6 px-0 d-flex mb-3">
	 			<div class="col-3 px-2 text-start pt-1">
	 			...
	 			<div class="col-9 px-2">
	 				<input type="" name="phone" class="form-control" value="{{old('phone')}}" required="" min="2" max="255">
	 			</div> 
	 		</div>
	 		<div class="col-12 col-md-6 px-0 d-flex mb-3">
	 			<div class="col-3 px-2 text-start pt-1">
